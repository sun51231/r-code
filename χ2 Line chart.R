...
normal_data <- data.frame(
  ...
  pT_CsF_c1 = c(0.021, 0.053, 0.062, 0.070, 0.038, 0.034, 0.004, 0.002, 0.040, 0.005),
  pT_CsF_c2 = c(0.040, 0.056, 0.030, 0.021, 0.052, 0.032, 0.001, 0.000, 0.035, 0.007),
  pT_CsF_cr = c(0.040, 0.054, 0.026, 0.002, 0.052, 0.031, 0.001, 0.000, 0.035, 0.006),
  pEBA4_rls = c(0.049, 0.040, 0.089, 0.190, 0.032, 0.035, 0.103, 0.228, 0.032, 0.048),
  pols_2_rls = c(0.046, 0.041, 0.042, 0.060, 0.032, 0.024, 0.012, 0.010, 0.032, 0.006)
)

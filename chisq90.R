...
get_pvalues <- function(n) {
  ...
  c(chisq_mlb,chisq_rmlb,T_rls,CT_rls,T_F,T_F_c,T_F_c1,T_F_cr,T_CsF,T_CsF_c,T_CsF_c1,T_CsF_cr,p_mlb,p_rmlb,p_rls,p_CTrls,pT_F,pT_F_c,pT_F_c1,pT_F_cr,pT_CsF,pT_CsF_c,pT_CsF_c1,pT_CsF_cr,p_ml,pNTML,pSB,pEBAF,pEBA2,pEBA2J,pEBAA)
}

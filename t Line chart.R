...
normal_data <- data.frame(
  ...
  pT_CsF_c1 = c(0.032, 0.055, 0.039, 0.049, 0.040, 0.020, 0.002, 0.000, 0.028, 0.002),
  pT_CsF_c2 = c(0.062, 0.057, 0.018, 0.014, 0.058, 0.020, 0.001, 0.000, 0.026, 0.003),
  pT_CsF_cr = c(0.062, 0.057, 0.016, 0.001, 0.058, 0.019, 0.000, 0.000, 0.026, 0.003),
  pEBA4_rls = c(0.060, 0.045, 0.088, 0.193, 0.038, 0.037, 0.092, 0.209, 0.028, 0.042),
  pols_2_rls = c(0.059, 0.047, 0.050, 0.061, 0.039, 0.024, 0.009, 0.006, 0.028, 0.004)
)
...
ggplot(data_long, aes(x = p_N, y = Rejection_Rate, color = Test, group = Test)) +
  ...
  labs(
    title = "Rejection Rates by p/N Ratio (t Distribution)",
    x = "p/N Ratio",
    y = "Rejection Rate",
    color = "Test Method"
  ) +

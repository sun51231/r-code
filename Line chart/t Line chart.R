...
normal_data <- data.frame(
  ...
  pT_CsF_c1 = c(0.036, 0.057, 0.037, 0.049, 0.046, 0.021, 0.004, 0.001, 0.028, 0.001),
  pT_CsF_c2 = c(0.071, 0.061, 0.016, 0.013, 0.061, 0.021, 0.002, 0.001, 0.027, 0.001),
  pT_CsF_cr = c(0.071, 0.061, 0.015, 0, 0.061, 0.021, 0.001, 0, 0.027, 0.001),
  pEBA4_rls = c(0.070, 0.047, 0.096, 0.196, 0.047, 0.040, 0.103, 0.218, 0.027, 0.038),
  pols_2_rls = c(0.068, 0.049, 0.055, 0.069, 0.048, 0.023, 0.009, 0.003, 0.029, 0.004)
)

...
normal_data <- data.frame(
  ...
  pT_CsF_c1 = c(0.038, 0.134, 0.226, 0.28, 0.064, 0.123, 0.054, 0.016, 0.072, 0.027),
  pT_CsF_c2 = c(0.065, 0.142, 0.127, 0.107, 0.086, 0.12, 0.033, 0.003, 0.068, 0.03),
  pT_CsF_cr = c(0.065, 0.138, 0.11, 0.014, 0.085, 0.116, 0.02, 0.001, 0.068, 0.029),
  pEBA4_rls = c(0.069, 0.083, 0.222, 0.465, 0.046, 0.110, 0.304, 0.630, 0.048, 0.118),
  pols_2_rls = c(0.068, 0.082, 0.136, 0.179, 0.052, 0.071, 0.061, 0.077, 0.045, 0.013)
)

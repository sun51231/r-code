...
normal_data <- data.frame(
  ...
  pT_CsF_c1 = c(0.040, 0.135, 0.215, 0.279, 0.074, 0.111, 0.054, 0.020, 0.073, 0.024),
  pT_CsF_c2 = c(0.067, 0.143, 0.123, 0.110, 0.097, 0.108, 0.029, 0.004, 0.068, 0.030),
  pT_CsF_cr = c(0.067, 0.139, 0.102, 0.014, 0.096, 0.104, 0.018, 0.000, 0.068, 0.028),
  pEBA4_rls = c(0.069, 0.082, 0.212, 0.456, 0.056, 0.104, 0.316, 0.605, 0.052, 0.124),
  pols_2_rls = c(0.066, 0.081, 0.125, 0.179, 0.061, 0.066, 0.065, 0.070, 0.050, 0.015)
)
# 
test_names <- c(
  "pT_CsF_c1" = "CsF-c1",
...
ggplot(data_long, aes(x = p_N, y = Rejection_Rate, color = Test, group = Test)) +
  ...
  labs(
    title = "Rejection Rates by p/N Ratio (non-normality (skewness=3, kurtosis=21) Distribution)",
    x = "p/N Ratio",
    y = "Rejection Rate",
    color = "Test Method"
  ) +

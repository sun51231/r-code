...
normal_data <- data.frame(
  ...
  pT_CsF_c1 = c(0.019, 0.064, 0.114, 0.296, 0.037, 0.064, 0.091, 0.264, 0.049, 0.050),
  pT_CsF_c2 = c(0.040, 0.066, 0.061, 0.118, 0.058, 0.063, 0.052, 0.120, 0.046, 0.065),
  pT_CsF_cr = c(0.040, 0.066, 0.053, 0.025, 0.058, 0.062, 0.037, 0.015, 0.046, 0.062),
  pEBA4_rls = c(0.048, 0.038, 0.082, 0.155, 0.043, 0.034, 0.076, 0.173, 0.033, 0.036),
  pols_2_rls = c(0.047, 0.040, 0.048, 0.043, 0.043, 0.026, 0.007, 0.004, 0.034, 0.007)
)
# 
test_names <- c(
  "pT_CsF_c1" = "CsF-c1",

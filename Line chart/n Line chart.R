...
normal_data <- data.frame(
  ...
  pT_CsF_c1 = c(0.029, 0.060, 0.100, 0.317, 0.037, 0.058, 0.116, 0.417, 0.045, 0.073),
  pT_CsF_c2 = c(0.048, 0.064, 0.052, 0.139, 0.055, 0.056, 0.072, 0.241, 0.042, 0.082),
  pT_CsF_cr = c(0.048, 0.062, 0.048, 0.043, 0.054, 0.054, 0.058, 0.061, 0.042, 0.080),
  pEBA4_rls = c(0.056, 0.046, 0.056, 0.107, 0.039, 0.024, 0.057, 0.128, 0.035, 0.036),
  pols_2_rls = c(0.055, 0.050, 0.033, 0.028, 0.038, 0.021, 0.006, 0.002, 0.037, 0.006)
)
# 
test_names <- c(
  "pT_CsF_c1" = "CsF-c1",

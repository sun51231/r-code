...
normal_data <- data.frame(
  ...
  pT_CsF_c1 = c(0.024, 0.079, 0.118, 0.216, 0.044, 0.076, 0.052, 0.050, 0.062, 0.034),
  pT_CsF_c2 = c(0.047, 0.086, 0.060, 0.080, 0.061, 0.075, 0.028, 0.013, 0.056, 0.044),
  pT_CsF_cr = c(0.047, 0.084, 0.050, 0.010, 0.061, 0.073, 0.020, 0.000, 0.055, 0.040),
  pEBA4_rls = c(0.047, 0.046, 0.116, 0.229, 0.038, 0.048, 0.130, 0.282, 0.037, 0.044),
  pols_2_rls = c(0.045, 0.050, 0.061, 0.073, 0.039, 0.032, 0.014, 0.008, 0.038, 0.006)
)
# 
test_names <- c(
  "pT_CsF_c1" = "CsF-c1",

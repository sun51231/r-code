...
lambda <- cbind(
  c(loadings, rep(0, 55)),
  c(rep(0, 5), loadings, rep(0, 50)),
  c(rep(0, 10), loadings, rep(0, 45)),
  c(rep(0, 15), loadings, rep(0, 40)),
  c(rep(0, 20), loadings, rep(0, 35)),
  c(rep(0, 25), loadings, rep(0, 30)),
  c(rep(0, 30), loadings, rep(0, 25)),
  c(rep(0, 35), loadings, rep(0, 20)),
  c(rep(0, 40), loadings, rep(0, 15)),
  c(rep(0, 45), loadings, rep(0, 10)),
  c(rep(0, 50), loadings, rep(0, 5)),
  c(rep(0, 55), loadings)
)
phi <- matrix(c(1,.3,.3,.3,.3,.3,.3,.3,.3,.3,.3,.3,
